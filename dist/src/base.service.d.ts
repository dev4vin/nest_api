 ...
 * @alias BaseService
 */
export declare type BaseServiceImpl<T extends Model> = {
    /**
     *
     ...
     */
    buildQuery(paginatedInfo: PaginateDto, alias?: string | undefined, transform?: ((key: string, value: any) => any) | undefined, ref?: {
        new (): Model;
    } | undefined): SelectQueryBuilder<T> | SelectQueryBuilder<{
        new (): Model;
    }>;
    /**
     *
     ...
     */
    findMany(paginatedInfo: PaginateDto, ref?: {
        new (): Model;
    } | undefined): Promise<T[]> | Promise<Model[]>;
    /**
     *
     *
     * @param {number} id
     ...
     * @return {*}  {(Promise<T> | Promise<Model>)}
     */
    updateInfo(id: number, info: any, ref?: {
        new (): Model;
    } | undefined): Promise<T> | Promise<Model>;
    /**
     *
